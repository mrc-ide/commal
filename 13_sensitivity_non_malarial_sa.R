### Model fitting: sensitivity non-malarial SA threshold #######################
...
saveRDS(mcmc, "ignore/prob_hosp/mcmc_fits/mcmc_sensitivity_non_malaria_sa.rds")
#plot_par(mcmc)
...
saveRDS(parameters, "ignore/prob_hosp/mcmc_fits/parameters_sensitivity_non_malaria_sa.rds")
################################################################################
################################################################################
################################################################################