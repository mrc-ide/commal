...
saveRDS(mcmc, "ignore/prob_hosp/mcmc_fits/mcmc_sensitivity_rdt.rds")
#plot_par(mcmc)
...
saveRDS(parameters, "ignore/prob_hosp/mcmc_fits/parameters_sensitivity_rdt.rds")
################################################################################
################################################################################
################################################################################